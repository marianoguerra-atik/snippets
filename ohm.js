(function (global, factory) {
  ...
  function cannotOverrideUndeclaredRule(ruleName, grammarName, optSource) {
    return createError(
      "Cannot override rule " + ruleName + " because it is not declared in " +
        grammarName,
      optSource,
    );
  }
  ...
  function cannotExtendUndeclaredRule(ruleName, grammarName, optSource) {
    return createError(
      "Cannot extend rule " + ruleName + " because it is not declared in " +
        grammarName,
      optSource,
    );
  }
  ...
  function duplicateParameterNames(ruleName, duplicates, source) {
    return createError(
      "Duplicate parameter names in rule " + ruleName + ": " +
        duplicates.join(", "),
      source,
    );
  }
  ...
  function applicationOfSyntacticRuleFromLexicalContext(ruleName, applyExpr) {
    return createError(
      "Cannot apply syntactic rule " + ruleName +
  ...
  function invalidCodePoint(applyWrapper) {
    ...
    assert(
      node && node.isNonterminal() &&
        node.ctorName === "escapeChar_unicodeCodePoint",
    );

    // Get an interval that covers all of the hex digits.
    const digitIntervals = applyWrapper.children.slice(1, -1).map((d) =>
      d.source
    );
  ...
  function getLineAndColumn(str, offset) {
    ...
    if (prevLineStartOffset >= 0) {
      ...
      prevLine = str.slice(prevLineStartOffset, lineStartOffset).replace(
        /\r?\n$/,
        "",
      );
    }
    ...
    matchString(s, optIgnoreCase) {
      ...
      if (optIgnoreCase) {
        ...
        for (idx = 0; idx < s.length; idx++) {
          ...
          if (
            actual == null || actual.toUpperCase() !== expected.toUpperCase()
          ) {
            return false;
          }
        }
  ...
  class MatchResult {
    ...
    getRightmostFailures() {
      if (!this._rightmostFailures) {
        ...
        this._rightmostFailures = matchResultWithFailures
          .getRightmostFailures();
      }
  ...
  */
  ...
  Apply.prototype._assertAllApplicationsAreValid = function (
    ...
    if (
      !skipSyntacticCheck && isSyntactic(this.ruleName) && !isContextSyntactic
    ) {
    ...
    const isBuiltInApplySyntactic = BuiltInRules$1 &&
      ruleInfo === BuiltInRules$1.rules.applySyntactic;
    const isBuiltInCaseInsensitive = BuiltInRules$1 &&
      ruleInfo === BuiltInRules$1.rules.caseInsensitive;
  ...
  class Node {
    ...
    firstChild() {
      if (this.hasNoChildren()) {
        throw new Error(
          "cannot get first child of a " + this.ctorName +
    ...
    lastChild() {
      if (this.hasNoChildren()) {
        throw new Error(
          "cannot get last child of a " + this.ctorName +
            " node, which has no children",
        );
      } else {
  ...
  */
  ...
  Range.prototype.eval = function (state) {
    ...
    if (
      cp !== undefined && this.from.codePointAt(0) <= cp &&
  ...
  Iter.prototype.eval = function (state) {
    ...
    if (numMatches > 0) {
      ...
      const endOffset = lastColOffsets[lastColOffsets.length - 1] +
  ...
  Apply.prototype.reallyEval = function (state) {
    ...
    const memoKey = this.toMemoKey();
    const isHeadOfLeftRecursion = currentLR &&
      currentLR.headApplication.toMemoKey() === memoKey;
    let memoRec;
  ...
  */
  ...
  Opt.prototype.toArgumentNameList = function (firstArgIndex, noDupCheck) {
    return this.expr.toArgumentNameList(firstArgIndex, noDupCheck).map(
      (argName) => {
  ...
  Lookahead.prototype.toArgumentNameList =
    Lex.prototype.toArgumentNameList =
      function (firstArgIndex, noDupCheck) {
  ...
  */
  ...
  Not.prototype.toFailure = function (grammar) {
    const description = this.expr === any
      ? "nothing"
  ...
  */
  ...
  class MatchState {
    ...
    inLexifiedContext() {
      return this
        .inLexifiedContextStack[this.inLexifiedContextStack.length - 1];
    }
    ...
    useMemoizedResult(origPos, memoRec) {
      ...
      const memoRecRightmostFailurePosition = this.inputStream.pos +
        memoRec.rightmostFailureOffset;
      this.rightmostFailurePosition = Math.max(
        this.rightmostFailurePosition,
  ...
  class Matcher {
    ...
    replaceInputRange(startIdx, endIdx, str) {
      ...
      // update input
      this._input = prevInput.slice(0, startIdx) + str +
        prevInput.slice(endIdx);
    ...
    _match(startExpr, options = {}) {
      ...
      if (!opts.incremental) {
        ...
        this._isMemoTableStale && !this.grammar.supportsIncrementalParsing
      ) {
    ...
    */
    _getStartExpr(optStartApplicationStr) {
      const applicationStr = optStartApplicationStr ||
        this.grammar.defaultStartRule;
      if (!applicationStr) {
        throw new Error(
  ...
  class Semantics {
    constructor(grammar, superSemantics) {
      ...
      // argument.
      this.Wrapper = class
        extends (superSemantics ? superSemantics.Wrapper : Wrapper) {
        constructor(node, sourceInterval, baseInterval) {
  ...
  function newDefaultAction(type, name, doIt) {
    return function (...children) {
      const thisThing = this._semantics.operations[name] ||
  ...
  Semantics.createSemantics = function (grammar, optSuperSemantics) {
    ...
    proxy._getActionDict = function (operationOrAttributeName) {
      const action = s.operations[operationOrAttributeName] ||
  ...
  class Grammar {
    ...
    isBuiltIn() {
      return this === Grammar.ProtoBuiltInRules ||
    ...
    _checkTopDownActionDict(what, name, actionDict) {
      ...
      for (const k in actionDict) {
        ...
        if (actual !== expected) {
          ...
          problems.push(
            `Semantic action '${k}' has the wrong arity: ${details}`,
          );
        }
      }
    ...
    toRecipe(superGrammarExpr = undefined) {
      ...
      Object.keys(this.rules).forEach((ruleName) => {
        ...
        const { body } = ruleInfo;
        const isDefinition = !this.superGrammar ||
          !this.superGrammar.rules[ruleName];
  ...
  class GrammarDecl {
    ...
    ensureSuperGrammarRuleForOverriding(name, source) {
      ...
      if (!ruleInfo) {
        throw cannotOverrideUndeclaredRule(
          name,
  ...
  var BuiltInRules = makeRecipe([
    ...
    null,
    {
      ...
      "letter": ["define", { "sourceInterval": [82, 142] }, "a letter", [], [
        "alt",
      ...
      "digit": ["define", { "sourceInterval": [146, 177] }, "a digit", [], [
        "range",
      ...
      "ListOf": ["define", { "sourceInterval": [258, 336] }, null, [
        "elem",
        "sep",
      ], ["alt", { "sourceInterval": [282, 336] }, [
        "app",
        { "sourceInterval": [282, 307] },
        "NonemptyListOf",
        [["param", { "sourceInterval": [297, 301] }, 0], ["param", {
          "sourceInterval": [303, 306],
        }, 1]],
      ], ["app", { "sourceInterval": [314, 336] }, "EmptyListOf", [["param", {
        "sourceInterval": [326, 330],
      }, 0], ["param", { "sourceInterval": [332, 335] }, 1]]]]],
      "NonemptyListOf": ["define", { "sourceInterval": [340, 388] }, null, [
        "elem",
        "sep",
      ], ["seq", { "sourceInterval": [372, 388] }, ["param", {
        "sourceInterval": [372, 376],
      }, 0], ["star", { "sourceInterval": [377, 388] }, [
        "seq",
        { "sourceInterval": [378, 386] },
        ["param", { "sourceInterval": [378, 381] }, 1],
        ["param", { "sourceInterval": [382, 386] }, 0],
      ]]]],
      "EmptyListOf": ["define", { "sourceInterval": [392, 434] }, null, [
        "elem",
        "sep",
      ], ["seq", { "sourceInterval": [438, 438] }]],
      "listOf": ["define", { "sourceInterval": [438, 516] }, null, [
        "elem",
        "sep",
      ], ["alt", { "sourceInterval": [462, 516] }, [
        "app",
        { "sourceInterval": [462, 487] },
        "nonemptyListOf",
        [["param", { "sourceInterval": [477, 481] }, 0], ["param", {
          "sourceInterval": [483, 486],
        }, 1]],
      ], ["app", { "sourceInterval": [494, 516] }, "emptyListOf", [["param", {
        "sourceInterval": [506, 510],
      }, 0], ["param", { "sourceInterval": [512, 515] }, 1]]]]],
      "nonemptyListOf": ["define", { "sourceInterval": [520, 568] }, null, [
        "elem",
        "sep",
      ], ["seq", { "sourceInterval": [552, 568] }, ["param", {
        "sourceInterval": [552, 556],
      }, 0], ["star", { "sourceInterval": [557, 568] }, [
        "seq",
        { "sourceInterval": [558, 566] },
        ["param", { "sourceInterval": [558, 561] }, 1],
        ["param", { "sourceInterval": [562, 566] }, 0],
      ]]]],
      "emptyListOf": ["define", { "sourceInterval": [572, 682] }, null, [
        "elem",
        "sep",
      ], ["seq", { "sourceInterval": [685, 685] }]],
      "applySyntactic": ["define", { "sourceInterval": [685, 710] }, null, [
        "app",
  ...
  var ohmGrammar = makeRecipe([
    ...
    "Grammars",
    {
      "Grammars": ["define", { "sourceInterval": [9, 32] }, null, [], ["star", {
        "sourceInterval": [24, 32],
      }, ["app", { "sourceInterval": [24, 31] }, "Grammar", []]]],
      "Grammar": ["define", { "sourceInterval": [36, 83] }, null, [], [
        "seq",
        { "sourceInterval": [50, 83] },
        ["app", { "sourceInterval": [50, 55] }, "ident", []],
        ["opt", { "sourceInterval": [56, 69] }, [
          "app",
      ...
      "Rule_override": ["define", { "sourceInterval": [188, 248] }, null, [], [
        "seq",
        { "sourceInterval": [188, 235] },
        ["app", { "sourceInterval": [188, 193] }, "ident", []],
        ["opt", { "sourceInterval": [194, 202] }, [
          "app",
      ...
      "Rule_extend": ["define", { "sourceInterval": [255, 305] }, null, [], [
        "seq",
        { "sourceInterval": [255, 294] },
        ["app", { "sourceInterval": [255, 260] }, "ident", []],
        ["opt", { "sourceInterval": [261, 269] }, [
          "app",
      ...
      "Rule": ["define", { "sourceInterval": [120, 305] }, null, [], [
        "alt",
      ...
      "RuleBody": ["define", { "sourceInterval": [309, 362] }, null, [], [
        "seq",
        { "sourceInterval": [324, 362] },
        ["opt", { "sourceInterval": [324, 328] }, ["terminal", {
          "sourceInterval": [324, 327],
        }, "|"]],
        ["app", { "sourceInterval": [329, 362] }, "NonemptyListOf", [[
          "app",
      ...
      "TopLevelTerm": ["define", { "sourceInterval": [366, 418] }, null, [], [
        "alt",
      ...
      "OverrideRuleBody": [
        ...
        null,
        [],
        ["seq", { "sourceInterval": [445, 491] }, ["opt", {
      ...
      "Formals": ["define", { "sourceInterval": [566, 606] }, null, [], [
        "seq",
        { "sourceInterval": [580, 606] },
        ["terminal", { "sourceInterval": [580, 583] }, "<"],
        ["app", { "sourceInterval": [584, 602] }, "ListOf", [[
          "app",
      ...
      "Params": ["define", { "sourceInterval": [610, 647] }, null, [], [
        "seq",
        { "sourceInterval": [623, 647] },
        ["terminal", { "sourceInterval": [623, 626] }, "<"],
        ["app", { "sourceInterval": [627, 643] }, "ListOf", [[
          "app",
      ...
      "Base_application": [
        ...
        null,
        [],
        ["seq", { "sourceInterval": [918, 963] }, [
          "app",
          { "sourceInterval": [918, 923] },
          "ident",
          [],
        ], ["opt", { "sourceInterval": [924, 931] }, [
          "app",
          { "sourceInterval": [924, 930] },
          "Params",
          [],
        ]], ["not", { "sourceInterval": [932, 963] }, [
          "alt",
          { "sourceInterval": [934, 962] },
          ["seq", { "sourceInterval": [934, 948] }, ["opt", {
      ...
      "Base_range": ["define", { "sourceInterval": [986, 1041] }, null, [], [
        "seq",
      ...
      "Base_paren": ["define", { "sourceInterval": [1113, 1168] }, null, [], [
        "seq",
      ...
      "Base": ["define", { "sourceInterval": [907, 1168] }, null, [], [
        "alt",
      ...
      "ruleDescr": [
        ...
        "a rule description",
        [],
        ["seq", { "sourceInterval": [1210, 1231] }, ["terminal", {
      ...
      "terminal": ["define", { "sourceInterval": [1493, 1531] }, null, [], [
        "seq",
        { "sourceInterval": [1508, 1531] },
        ["terminal", { "sourceInterval": [1508, 1512] }, '"'],
        ["star", { "sourceInterval": [1513, 1526] }, [
          "app",
      ...
      "oneCharTerminal": [
        ...
        null,
        [],
        ["seq", { "sourceInterval": [1557, 1579] }, ["terminal", {
      ...
      "terminalChar": ["define", { "sourceInterval": [1583, 1660] }, null, [], [
        "alt",
        { "sourceInterval": [1602, 1660] },
        ["app", { "sourceInterval": [1602, 1612] }, "escapeChar", []],
        ["seq", { "sourceInterval": [1621, 1660] }, ["not", {
          "sourceInterval": [1621, 1626],
        }, ["terminal", { "sourceInterval": [1622, 1626] }, "\\"]], ["not", {
          "sourceInterval": [1627, 1632],
        }, ["terminal", { "sourceInterval": [1628, 1632] }, '"']], ["not", {
      ...
      "escapeChar_unicodeCodePoint": [
        ...
        [
          ...
          ["opt", { "sourceInterval": [2155, 2164] }, [
            "app",
            { "sourceInterval": [2155, 2163] },
            "hexDigit",
            [],
          ]],
          ["opt", { "sourceInterval": [2165, 2174] }, [
            "app",
            { "sourceInterval": [2165, 2173] },
            "hexDigit",
            [],
          ]],
          ["opt", { "sourceInterval": [2188, 2197] }, [
            "app",
            { "sourceInterval": [2188, 2196] },
            "hexDigit",
            [],
          ]],
          ["opt", { "sourceInterval": [2198, 2207] }, [
            "app",
            { "sourceInterval": [2198, 2206] },
            "hexDigit",
            [],
          ]],
          ["opt", { "sourceInterval": [2208, 2217] }, [
            "app",
      ...
      "space": ["extend", { "sourceInterval": [2375, 2394] }, null, [], [
        "app",
      ...
      "comment_singleLine": [
        ...
        null,
        [],
        ["seq", { "sourceInterval": [2412, 2443] }, ["terminal", {
          "sourceInterval": [2412, 2416],
        }, "//"], ["star", { "sourceInterval": [2417, 2429] }, ["seq", {
          "sourceInterval": [2418, 2427],
        }, ["not", { "sourceInterval": [2418, 2423] }, ["terminal", {
          "sourceInterval": [2419, 2423],
        }, "\n"]], ["app", { "sourceInterval": [2424, 2427] }, "any", []]]], [
          "lookahead",
          { "sourceInterval": [2430, 2443] },
          ["alt", { "sourceInterval": [2432, 2442] }, ["terminal", {
      ...
      "comment_multiLine": [
        ...
        null,
        [],
        ["seq", { "sourceInterval": [2465, 2487] }, ["terminal", {
          "sourceInterval": [2465, 2469],
        }, "/*"], ["star", { "sourceInterval": [2470, 2482] }, ["seq", {
          "sourceInterval": [2471, 2480],
        }, ["not", { "sourceInterval": [2471, 2476] }, ["terminal", {
      ...
      "operator": ["define", { "sourceInterval": [2604, 2669] }, null, [], [
        "alt",
      ...
      "punctuation": ["define", { "sourceInterval": [2673, 2709] }, null, [], [
        "alt",
  ...
  function buildGrammar(match, namespace, optOhmGrammarForTesting) {
    ...
    const helpers = metaGrammar.createSemantics().addOperation("visit", {
      ...
      Seq(expr) {
        return builder.seq(...expr.children.map((c) => c.visit())).withSource(
          this.source,
        );
      },
  ...
  var operationsAndAttributesGrammar = makeRecipe([
    ...
    "AttributeSignature",
    {
      ...
      "OperationSignature": [
        ...
        null,
        [],
        ["seq", { "sourceInterval": [87, 100] }, [
          "app",
          { "sourceInterval": [87, 91] },
          "name",
          [],
        ], ["opt", { "sourceInterval": [92, 100] }, [
          "app",
      ...
      "Formals": ["define", { "sourceInterval": [104, 143] }, null, [], [
        "seq",
        { "sourceInterval": [118, 143] },
        ["terminal", { "sourceInterval": [118, 121] }, "("],
        ["app", { "sourceInterval": [122, 139] }, "ListOf", [[
          "app",
      ...
      "name": ["define", { "sourceInterval": [147, 187] }, "a name", [], [
        "seq",
        { "sourceInterval": [168, 187] },
        ["app", { "sourceInterval": [168, 177] }, "nameFirst", []],
        ["star", { "sourceInterval": [178, 187] }, [
          "app",
  ...
  function initBuiltInSemantics(builtInRules) {
    ...
    Semantics.BuiltInSemantics = Semantics.createSemantics(builtInRules, null)
      .addOperation(
        "asIteration",
        {
  ...
  function initPrototypeParser(grammar) {
    Semantics.prototypeGrammarSemantics = grammar.createSemantics()
      .addOperation("parse", {
